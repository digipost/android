            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(DisplayContentActivity.this)
                    .setPositiveButton(R.string.invoice_dialog_choose_bank_button, new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            GAEventController.sendInvoiceClickedChooseBankDialogue(getParent(), getString(R.string.invoice_dialog_choose_bank_button));
                        ...
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            GAEventController.sendInvoiceClickedChooseBankDialogue(getParent(), getString(R.string.invoice_dialog_later_button));
                            dialogInterface.dismiss();
                        }
                    }).setNegativeButton(R.string.invoice_dialog_forget_button, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int which) {
                            GAEventController.sendInvoiceClickedChooseBankDialogue(getParent(), getString(R.string.invoice_dialog_forget_button));
