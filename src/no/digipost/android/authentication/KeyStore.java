...
public class KeyStore {
	...
	private boolean put(final byte[] key, final byte[] value) {
		execute('i', key, value);
	...
	private boolean delete(final byte[] key) {
		execute('d', key);
		return mError == NO_ERROR;
	}
	...
	private boolean contains(final byte[] key) {
		execute('e', key);
		return mError == NO_ERROR;
	}
	...
	private boolean password(final byte[] password) {
		execute('p', password);
		return mError == NO_ERROR;
	}
	...
	private boolean unlock(final byte[] password) {
		execute('u', password);
		return mError == NO_ERROR;
	}
	...
	private ArrayList<byte[]> execute(int code, final byte[]... parameters) {
